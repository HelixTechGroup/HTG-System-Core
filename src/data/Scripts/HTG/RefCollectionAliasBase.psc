Scriptname HTG:RefCollectionAliasBase extends RefCollectionAlias
{Base HTG RefCollectionAlias}
import HTG
...
Event OnTimer(Int aiTimerID)
    ...
    ElseIf aiTimerID == _timerIds.MainId
        ...
        Int kMaxStarWait = _waitDefaults.MaxCycles
...
Event HTG:RefCollectionAliasBase.OnInitialRun(HTG:RefCollectionAliasBase akSender, Var[] akArgs)
EndEvent

Event HTG:RefCollectionAliasBase.OnMain(HTG:RefCollectionAliasBase akSender, Var[] akArgs)
EndEvent
