Scriptname HTG:ActivatorBase extends ObjectReference
{Base HTG Activator}
import HTG
import HTG:Structs
...
Event HTG:ActivatorBase.OnInitialRun(HTG:ActivatorBase akSender, Var[] akArgs)
EndEvent

Event HTG:ActivatorBase.OnMain(HTG:ActivatorBase akSender, Var[] akArgs)
EndEvent
