Scriptname HTG:TerminalMenuBase extends TerminalMenu
{Base HTG TerminalMenu}
import HTG
import HTG:Structs
...
Event HTG:TerminalMenuBase.OnInitialRun(HTG:TerminalMenuBase akSender, Var[] akArgs)
EndEvent

Event HTG:TerminalMenuBase.OnMain(HTG:TerminalMenuBase akSender, Var[] akArgs)
EndEvent
