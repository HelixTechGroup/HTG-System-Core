Scriptname HTG:PerkExt extends HTG:PerkBase
{Extended Perk}
import HTG
import HTG:Structs
...
; Event HTG:PerkExt.OnInitialRun(HTG:PerkExt akSender, Var[] akArgs)
; EndEvent

; Event HTG:PerkExt.OnMain(HTG:PerkExt akSender, Var[] akArgs)
; EndEvent
