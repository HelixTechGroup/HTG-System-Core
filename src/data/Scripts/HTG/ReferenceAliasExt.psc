...
Event OnInit()
  Self.RegisterForCustomEvent(Self as ScriptObject, "htg:referencealiasext_OnInitialRun") ; #DEBUG_LINE_NO:43
  Self.RegisterForCustomEvent(Self as ScriptObject, "htg:referencealiasext_OnMain") ; #DEBUG_LINE_NO:44
...
Event OnTimer(Int aiTimerID)
  ...
  ElseIf aiTimerID == _timerIds.InitialRunId ; #DEBUG_LINE_NO:93
    ...
    Guard _readyTimerGuard ;*** WARNING: Experimental syntax, may be incorrect: Guard  ; #DEBUG_LINE_NO:99
      ...
      Self.SendCustomEvent("htg:referencealiasext_OnInitialRun", None) ; #DEBUG_LINE_NO:101
  ...
  ElseIf aiTimerID == _timerIds.MainId ; #DEBUG_LINE_NO:109
    ...
    Guard _mainTimerGuard ;*** WARNING: Experimental syntax, may be incorrect: Guard  ; #DEBUG_LINE_NO:128
      ...
      Self.SendCustomEvent("htg:referencealiasext_OnMain", None) ; #DEBUG_LINE_NO:130
