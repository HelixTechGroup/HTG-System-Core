Scriptname HTG:PerkBase extends Perk
{Base HTG Perk}
import HTG
import HTG:Structs
...
Event HTG:PerkBase.OnInitialRun(HTG:PerkBase akSender, Var[] akArgs)
EndEvent

Event HTG:PerkBase.OnMain(HTG:PerkBase akSender, Var[] akArgs)
EndEvent
