Scriptname HTG:ScriptObjectBase extends ScriptObject
{Base HTG ScriptObject}
import HTG
import HTG:Structs
...
Event HTG:ScriptObjectBase.OnInitialRun(HTG:ScriptObjectBase akSender, Var[] akArgs)
EndEvent

Event HTG:ScriptObjectBase.OnMain(HTG:ScriptObjectBase akSender, Var[] akArgs)
EndEvent
