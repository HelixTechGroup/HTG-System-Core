...
Event HTG:ScriptObjectExt.OnInitialRun(HTG:ScriptObjectExt akSender, Var[] akArgs)
  ; Empty function
EndEvent

Event HTG:ScriptObjectExt.OnMain(HTG:ScriptObjectExt akSender, Var[] akArgs)
  ; Empty function
EndEvent
...
Event OnInit()
  Self.RegisterForCustomEvent(Self as ScriptObject, "htg:scriptobjectext_OnInitialRun") ; #DEBUG_LINE_NO:43
  Self.RegisterForCustomEvent(Self as ScriptObject, "htg:scriptobjectext_OnMain") ; #DEBUG_LINE_NO:44
...
Event OnTimer(Int aiTimerID)
  ...
  ElseIf aiTimerID == _timerIds.InitialRunId ; #DEBUG_LINE_NO:80
    ...
    Guard _readyTimerGuard ;*** WARNING: Experimental syntax, may be incorrect: Guard  ; #DEBUG_LINE_NO:86
      ...
      Self.SendCustomEvent("htg:scriptobjectext_OnInitialRun", None) ; #DEBUG_LINE_NO:88
  ...
  ElseIf aiTimerID == _timerIds.MainId ; #DEBUG_LINE_NO:96
    ...
    Guard _mainTimerGuard ;*** WARNING: Experimental syntax, may be incorrect: Guard  ; #DEBUG_LINE_NO:103
      ...
      Self.SendCustomEvent("htg:scriptobjectext_OnMain", None) ; #DEBUG_LINE_NO:105
