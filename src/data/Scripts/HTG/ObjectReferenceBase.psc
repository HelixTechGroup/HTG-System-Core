Scriptname HTG:ObjectReferenceBase extends ObjectReference
{Base HTG ObjectReference}
import HTG
import HTG:Structs
...
; HTG:SystemUtilities Property Utilities Auto Const Mandatory
    ...
    If aiTimerID == _timerIds.InitializeId
        ...
        TryLockGuard _initializeTimerGuard, _initializeGuard
            ...
            ElseIf !_isInitialized && _currentTimerCycle == _maxTimerCycle
                LogObjectGlobal(Self, "HTG:SystemUtililities could not be Initialized")
            Else
                LogObjectGlobal(Self, "InitializeTimer - Is Initialized. Starting ReadyTimer")
                timerId = _timerIds.InitialRunId
            EndIf
...
Event HTG:ObjectReferenceBase.OnInitialRun(HTG:ObjectReferenceBase akSender, Var[] akArgs)
EndEvent

Event HTG:ObjectReferenceBase.OnMain(HTG:ObjectReferenceBase akSender, Var[] akArgs)
EndEvent
