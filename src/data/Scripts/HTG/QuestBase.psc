Scriptname HTG:QuestBase extends Quest
{Base HTG Quest}
...
Event HTG:QuestBase.OnInitialRun(HTG:QuestBase akSender, Var[] akArgs)
EndEvent

Event HTG:QuestBase.OnMain(HTG:QuestBase akSender, Var[] akArgs)
EndEvent
