Scriptname HTG:Unity:Quests:SQ_UnityEvent extends HTG:QuestExt
{Regenesys:Unity Event Controller}
import HTG
...
Event Quest.OnQuestInit(Quest akSender)
    ...
    If akSender == BeginUnityQuest
        ...
        ; If UnityCharGenEnabled.GetValue() == 1.0
...
Bool Function _Init()
    If IsNone(_completeVariantList)
        _completeVariantList = HTG:Collections:FormListExt.FormListExt()
    EndIf
