...
Event OnInit()
  Self.RegisterForCustomEvent(Self as ScriptObject, "htg:terminalmenuext_OnInitialRun") ; #DEBUG_LINE_NO:44
  Self.RegisterForCustomEvent(Self as ScriptObject, "htg:terminalmenuext_OnMain") ; #DEBUG_LINE_NO:45
...
Event OnTimer(Int aiTimerID)
  ...
  ElseIf aiTimerID == _timerIds.InitialRunId ; #DEBUG_LINE_NO:88
    ...
    Guard _readyTimerGuard ;*** WARNING: Experimental syntax, may be incorrect: Guard  ; #DEBUG_LINE_NO:94
      ...
      Self.SendCustomEvent("htg:terminalmenuext_OnInitialRun", None) ; #DEBUG_LINE_NO:96
  ...
  ElseIf aiTimerID == _timerIds.MainId ; #DEBUG_LINE_NO:104
    ...
    Guard _mainTimerGuard ;*** WARNING: Experimental syntax, may be incorrect: Guard  ; #DEBUG_LINE_NO:111
      ...
      Self.SendCustomEvent("htg:terminalmenuext_OnMain", None) ; #DEBUG_LINE_NO:113
